...
// table config
import { InvitationHistoryTableConfig } from './config.invitationHistory';
...
export const InvitationHistoryTable: React.FC<
...
> = ({ teamSlug }) => {
  ...
  const table = useReactTable({
    ...
    columns: InvitationHistoryTableConfig,
          ...
          {isLoading ? (
            ...
            <>
              {table.getRowModel().rows?.length ? (
                ...
                <TableRow>
                  <TableCell
                    colSpan={InvitationHistoryTableConfig.length}
